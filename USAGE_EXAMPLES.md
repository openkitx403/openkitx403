...
const client = new OpenKit403Client({ wallet: 'keypair' });

// Full authentication flow as before
...
Frontend (React) + Backend (Express) shown in the [Quick Start Guide](#). Clone the repo and run:
